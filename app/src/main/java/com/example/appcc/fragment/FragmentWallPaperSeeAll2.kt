...
class FragmentWallPaperSeeAll2 : BaseFragment(), AdapterWallPaperFavorite.ClickListener {
    ...
    override fun observeData() {
        iconViewModel.currentTheme.observe(this){
            ...
            adapterWallPaperFavorite = AdapterWallPaperFavorite(originalItemList, this)
            val gridLayoutManager = GridLayoutManager(requireContext(), 2)
            binding.recyclerSeeDetail.layoutManager = gridLayoutManager
            binding.recyclerSeeDetail.adapter = adapterWallPaperFavorite
