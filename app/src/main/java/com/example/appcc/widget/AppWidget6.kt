...
@AndroidEntryPoint
class AppWidget6 : AppWidgetProvider() {
    @Inject
    ...
    private fun updateAppWidget(
        ...
        val views = RemoteViews(context.packageName, R.layout.widget_icon_6)
        val currentWidget = dataRepository.getCurrentWidget()
        val bitmap = context.getBitmapFromAsset("Widget/widget$currentWidget/widget_6.webp")
