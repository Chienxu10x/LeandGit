...
@AndroidEntryPoint
class AppWidget5 : AppWidgetProvider(){
    @Inject
    ...
    private fun updateAppWidget(
        ...
        val views = RemoteViews(context.packageName, R.layout.widget_icon_5)
        val currentWidget = dataRepository.getCurrentWidget()
        val bitmap = context.getBitmapFromAsset("Widget/widget$currentWidget/widget_5.webp")
