...
class AdapterWallPaperFavorite(var contents: List<ContentX>, val listener: ClickListener) :
    RecyclerView.Adapter<AdapterWallPaperFavorite.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_wallpaper_favorites, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            val imageviewWallPaper : ImageView = findViewById(R.id.image_wallpaper_favorite)
